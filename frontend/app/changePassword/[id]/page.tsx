            ...
            <div className="h-full flex flex-col justify-center">
                <div className="flex justify-center">
                    <div className="flex flex-col border border-zinc-600 rounded-lg px-10 py-10">
                        ...
                        <input onChange={(e)=>{setPassword(e.target.value)}} className="mb-8 border border-black rounded-md py-2 px-2  w-[300px] text-black"/>
                        
                        <label className="my-2">Confirm Password</label>
                        <input onChange={(e)=>{setCnfPassword(e.target.value)}} className="mb-8 border border-black rounded-md py-2 px-2  w-[300px] text-black"/>

                        <div className="mt-8 flex justify-center">
                            <button onClick={()=> ChangePassword()} className="border px-4 py-2 rounded-lg border-slate-600 hover:text-blue-900 hover:border-blue-900 active:text-white">Update Password</button>
                        </div>
                    </div>
                </div>
            </div>  
