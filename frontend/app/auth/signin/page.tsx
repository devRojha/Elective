                ...
                <div className="flex justify-center">
                    <div className="flex flex-col border border-zinc-600 rounded-lg px-10 py-10">
                        ...
                        <div className="mt-8 flex justify-center">
                            <button onClick={()=> loginfun()} className="border px-4 py-2 rounded-lg border-zinc-500 hover:text-blue-900 hover:border-blue-900 active:text-white">Login</button>
                        </div>
